...
1. Откройте настройки приложения (нажмите OK/Enter на пульте или тап по экрану)
...
- **На пульте:** Нажмите кнопку **OK/Enter** на главном экране
- **На экране:** Тап по экрану на главном экране

### Навигация в диалогах

- Используйте **стрелки** на пульте для переключения между кнопками
- Кнопка в фокусе будет визуально выделена (увеличенный размер, тень)
- Нажмите **OK/Enter** для выбора кнопки
...
- Улучшенная навигация с пульта (визуальная индикация фокуса)
